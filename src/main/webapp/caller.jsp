							...
							<div class="ibox-content">
								<form class="form-horizontal" id="my-form" role="form">
									...
									<div class="form-group" id="data_1">
										<label class="col-sm-2 font-normal"><b>Trail Start
												Date</b></label>
									...
									<div class="form-group">
										...
										<div class=" col-sm-8 input-group clockpicker"
											data-autoclose="true">
											<input type="text" class="form-control" value="00:00"
												id="time"> <span class="input-group-addon"> <span
									...
									<div class="form-group" id="data_3">
										<label class="col-sm-2 font-normal"><b>Expiry Date</b></label>
										<div class="col-sm-10 input-group date">
											<span class="input-group-addon"><i
												class="fa fa-calendar"></i></span><input type="text"
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Lot Size/Qty</label>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">First Target</label>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Second Target</label>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Stop Loss</label>
						...
						$("#my-form")
								.submit(
										function(e) {
											...
											var trailStartDate = $(
													'#trail-start-date').val();
											var traiEndDate = $(
													'#trail-end-date').val();
											var time = $('#time').val();
											var secrip = $('#secrip').val();
											var longShort = $('#long-short')
													.val();
											var segment = $('#segment').val();
											var expiryDate = $('#expiry-date')
													.val();
											var strikePrice = $('#strike-price')
													.val();
											var lotsizeQty = $('#lot-size-qty')
													.val();
											...
											var formData = new FormData();
											 ...
											 $
											.ajax({
												url : 'http://localhost:8081/careservices/rest/client/trail/',
												type : 'POST',
												data : stringData,
