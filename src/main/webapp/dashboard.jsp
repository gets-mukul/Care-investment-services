		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="col-lg-2 tooltip-demo">
                    <div class="widget style1 blue-bg" data-toggle="tooltip" data-placement="top" title="Contacts Assigned">
                ...
                <div class="col-lg-2 tooltip-demo">
                    <div class="widget style1 navy-bg" data-toggle="tooltip" data-placement="top" title="Contacts Call Completed">
                        <div class="row vertical-align">
                            <div class="col-xs-3">
                ...
                <div class="col-lg-2 tooltip-demo">
                    <div class="widget style1 lazur-bg" data-toggle="tooltip" data-placement="top" title="Contacts Call Pending">
                        <div class="row vertical-align">
                            <div class="col-xs-3">
                ...
                <div class="col-lg-2 tooltip-demo">
                    ...
                    data-toggle="tooltip" data-placement="top" title="Contacts Busy/After some Time/Others" data-original-title="Tooltip on top">
                        <div class="row vertical-align">
                            <div class="col-xs-3">
                ...
                <div class="col-lg-2 tooltip-demo">
                    <div class="widget style1 yellow-bg" data-toggle="tooltip" data-placement="top" title="Contacts on Trial">
                        <div class="row vertical-align">
                            <div class="col-xs-3">
                ...
                <div class="col-lg-2 tooltip-demo">
                    <div class="widget style1 red-bg" data-toggle="tooltip" data-placement="top" title="Contacts not Trade">
                        <div class="row vertical-align">
                            <div class="col-xs-3">
...
<select class="select2_demo_2 form-control" multiple="multiple" id="employee_list">
