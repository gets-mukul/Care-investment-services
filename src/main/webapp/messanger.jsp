								...
								<div class="file-manager">
									...
									<ul class="folder-list m-b-md" style="padding: 0">
										<li><a href="mailbox.html"> <i class="fa fa-inbox "></i>
												Inbox <span class="label label-warning pull-right">16</span>
										</a></li>
										<li><a href="mailbox.html"> <i
												class="fa fa-envelope-o"></i> Send Mail
										</a></li>
										<li><a href="mailbox.html"> <i
												class="fa fa-certificate"></i> Important
										</a></li>
										<li><a href="mailbox.html"> <i
												class="fa fa-file-text-o"></i> Drafts <span
					...
					<div class="col-lg-9 animated fadeInRight">
						<div class="mail-box-header">
							<div class="pull-right tooltip-demo">
								<a href="mailbox.html" class="btn btn-white btn-sm"
									...
									title="Move to draft folder"><i class="fa fa-pencil"></i>
									Draft</a> <a href="mailbox.html" class="btn btn-danger btn-sm"
									data-toggle="tooltip" data-placement="top"
						...
						<div class="mail-box">
							...
							<div class="mail-body">
								...
								<form class="form-horizontal col-md-9" method="get">
									<div class="col-md-4">
									<label class=" control-label">To:</label>
									</div>
									
                                    <div>
                                    <select class="select2_demo_2 form-control select2-hidden-accessible col-sm-8" multiple="" tabindex="-1" aria-hidden="true">
							...
							<div class="mail-text h-200">
								...
								<div class="summernote" style="display: none;">
									...
									dummy text of the printing and typesetting industry. <strong>Lorem
										Ipsum has been the industry's</strong> standard dummy text ever since
